...
def main():
    ...
    hf_dataset_name = args.hf_org + args.real_image_dataset_name
    annotations_dir = 'test_data/annotations/' + args.real_image_dataset_name
    synthetic_images_dir = 'test_data/synthetic_images/' + args.real_image_dataset_name
    ...
    dataset = ImageDataset(args.hf_org + '/' + args.real_image_dataset_name, 'train')
